...
def get_git_checks(parser):
    return [
        ...
        ("Object Type Allowed Set (Exclude Reserved 5)",
         parser.parse_git_object_type(),
         SecurityConstraints.git_object_type_allowed_set,
         "Restricts object types to the exact Git on-disk type IDs {1,2,3,4,6,7}; value 5 is reserved and must not be accepted. Allowing reserved IDs can desynchronize object dispatch and trigger undefined parsing paths."),
